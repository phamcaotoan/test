...
test_driver.find_element(By.XPATH, '/html/body/form/main/div[2]/div[2]/div/div/div/div/div/div[1]/div[1]/div[1]/input').send_keys('ryan12345')


# Step 4: Nhập password
test_driver.find_element(By.XPATH, '/html/body/form/main/div[2]/div[2]/div/div/div/div/div/div[1]/div[1]/div[2]/input').send_keys('ryan54321')
